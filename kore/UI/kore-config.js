...
(function(KoreSDK){
    ...
    botOptions.botInfo = { name: "cakebuddy", "_id": "clientidinserthere" ,"customData":{"name":zdata} }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "clientidhere";
    botOptions.clientSecret = "clientsecrethere";
